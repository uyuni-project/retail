#
# spec file for package POS_Image-JeOS6-SLE11
#
...
Name:           POS_Image-JeOS6-SLE11
Version:        0.1
Release:        0
BuildRoot:      %{_tmppath}/%{name}-%{version}-build
Source:         POS_Image-JeOS6-SLE11-%{version}.tar.bz2
...
cp -pR jeos-6.0.0 %{buildroot}/usr/share/kiwi/image
